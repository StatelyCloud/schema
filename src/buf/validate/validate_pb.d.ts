 ...
 */
export declare const file_buf_validate_validate: GenDescFile;
 ...
 */
export declare const MessageConstraintsSchema: GenDescMessage<MessageConstraints>;
 ...
 */
export declare const OneofConstraintsSchema: GenDescMessage<OneofConstraints>;
 ...
 */
export declare const FieldConstraintsSchema: GenDescMessage<FieldConstraints>;
 ...
 */
export declare const FloatRulesSchema: GenDescMessage<FloatRules>;
 ...
 */
export declare const DoubleRulesSchema: GenDescMessage<DoubleRules>;
 ...
 */
export declare const Int32RulesSchema: GenDescMessage<Int32Rules>;
 ...
 */
export declare const Int64RulesSchema: GenDescMessage<Int64Rules>;
 ...
 */
export declare const UInt32RulesSchema: GenDescMessage<UInt32Rules>;
 ...
 */
export declare const UInt64RulesSchema: GenDescMessage<UInt64Rules>;
 ...
 */
export declare const SInt32RulesSchema: GenDescMessage<SInt32Rules>;
 ...
 */
export declare const SInt64RulesSchema: GenDescMessage<SInt64Rules>;
 ...
 */
export declare const Fixed32RulesSchema: GenDescMessage<Fixed32Rules>;
 ...
 */
export declare const Fixed64RulesSchema: GenDescMessage<Fixed64Rules>;
 ...
 */
export declare const SFixed32RulesSchema: GenDescMessage<SFixed32Rules>;
 ...
 */
export declare const SFixed64RulesSchema: GenDescMessage<SFixed64Rules>;
 ...
 */
export declare const BoolRulesSchema: GenDescMessage<BoolRules>;
 ...
 */
export declare const StringRulesSchema: GenDescMessage<StringRules>;
 ...
 */
export declare const BytesRulesSchema: GenDescMessage<BytesRules>;
 ...
 */
export declare const EnumRulesSchema: GenDescMessage<EnumRules>;
 ...
 */
export declare const RepeatedRulesSchema: GenDescMessage<RepeatedRules>;
 ...
 */
export declare const MapRulesSchema: GenDescMessage<MapRules>;
 ...
 */
export declare const AnyRulesSchema: GenDescMessage<AnyRules>;
 ...
 */
export declare const DurationRulesSchema: GenDescMessage<DurationRules>;
 ...
 */
export declare const TimestampRulesSchema: GenDescMessage<TimestampRules>;
 ...
 */
export declare const IgnoreSchema: GenDescEnum<Ignore>;
 ...
 */
export declare const KnownRegexSchema: GenDescEnum<KnownRegex>;
 ...
 */
export declare const message: GenDescExtension<MessageOptions, MessageConstraints>;
 ...
 */
export declare const oneof: GenDescExtension<OneofOptions, OneofConstraints>;
 ...
 */
export declare const field: GenDescExtension<FieldOptions, FieldConstraints>;
